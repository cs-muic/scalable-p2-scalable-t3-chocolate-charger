...
def frames_extraction_by2queues(filename, workId): 
    ...
    # push to queue 2
    job_worker2 = compose_queue.enqueue(image_compose, workId, on_failure=update_fail_status)
...
def frames_extraction(filename, workId): 
    ...
    # push to queue 2
    job_worker2 = compose_queue.enqueue(image_compose, workId, job_timeout='1h', on_failure=update_fail_status)
