...
def make_gif():
    ...
    job_worker1 = extract_queue.enqueue(frames_extraction,uploaded_filename, init_job_id, on_failure=update_fail_status)
...
def do_bucket():
    ...
    for i in range(len(lst)):
        ...
        redis_conn.set("current_job_id", str(init_job_id + 1))
        # enqueue to worker1
        job_worker1 = extract_queue.enqueue(frames_extraction,lst[i], init_job_id, on_failure=update_fail_status)
